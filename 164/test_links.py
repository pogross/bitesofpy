...
def test_make_html_links_first_data_set(my_file):
    lines = [
        b"https://www.python.org, Python Homepage",
        b"bad data,blabla,123",
        (b"https://pybit.es/generators.html , " b"Generators are Awesome "),
        b"more bad data",
    ]

    expected_links = [
        (b'<a href="https://www.python.org" target="_blank">' b"Python Homepage</a>"),
        (b'<a href="https://pybit.es/generators.html">' b"Generators are Awesome</a>"),
    ]
...
def test_make_html_links_second_data_set(my_file):
    ...
    expected_links = [
        (b'<a href="https://codechalleng.es/bites/">' b"Bites of Py</a>"),
        (
        ...
        (b'<a href="https://pybit.es/pages/about.html">' b"About Us</a>"),
        (b'<a href="https://nu.nl" target="_blank">' b"Dutch news site</a>"),
    ]

...
@pytest.mark.parametrize("args", [("Rock", "blabla"), ("blabla", "Rock")])
...
@pytest.mark.parametrize("player", ["Scissors", "Snake", "Human", "Wolf", "Sponge"])
...
@pytest.mark.parametrize("player", ["Paper", "Snake", "Human", "Wolf", "Sponge"])

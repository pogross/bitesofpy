...
mount_data = "https://bites-data.s3.us-east-2.amazonaws.com/" "mount-data{}.json"
...
@pytest.mark.parametrize(
    "file_no, expected, exception",
    [(1, mount1_expected, False), (2, mount2_expected, False), (3, None, True)],
)

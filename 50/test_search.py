...
@pytest.mark.parametrize(
    "arg, ret",
    [
        (datetime(2017, 9, 12, 8, 50, 0).timetuple(), date(year=2017, month=9, day=12)),
        (datetime(2017, 9, 8, 14, 30, 0).timetuple(), date(year=2017, month=9, day=8)),
        (
